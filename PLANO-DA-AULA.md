...
| **LED** + resistor 220–330 Ω | pino 8 | Ativ. 1 (P1) e Ativ. 2 (P2) |
...
- **Atividade 1:** o `1`/`0` que o botão envia é o mesmo que liga o pino 8. Na Parte 3, o
...
| LED não acende | Confira o **resistor** e a **polaridade** (perna maior = +, no pino 8). Teste com a Atividade 1 · Parte 1. |
...
aula-robotica-web/
├── sketches/
│   ├── atividade1/atividade1.ino     # LDR -> JSON; LED (pino 8) <- '1'/'0'
